...
public class DeliverySettingsPanel extends Composite implements Creator<DeliverySettingsDTO> {
    ...
    private final FixedBorderTextBox retryNumberTB;

    private final FixedBorderTextBox delayTB;

    public DeliverySettingsPanel() {
        FlexTable table = new FlexTable();
        retryNumberTB = new FixedBorderTextBox();
        delayTB = new FixedBorderTextBox();
