...
public class DeliveryButtonClickHandler implements ClickHandler {
    ...
    private class ShowDeliveryDialogCallback extends GenericCallback<
        ...
        private FlexTable createReportTable(Map<String, ResponseDTO<String>> result) {
            ...
            table.setWidget(0, 0, new HTML("<center><b>Доставка успешно запущена</center></b>"));
            table.setWidget(1, 0, new HTML("<center><b>Сервис</center></b>"));
            table.setWidget(1, 1, new HTML("<center><b>Статус</center></b>"));
            table.setWidget(1, 2, new HTML("<center><b>ID запроса</center></b>"));
